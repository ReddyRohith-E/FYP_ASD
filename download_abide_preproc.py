...
# python -u download_abide_preproc.py -d func_preproc -p cpac -s nofilt_noglobal -o ./abide_download -lt 10 -a
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        print('Using upper age threshold of {0:g}...'.format(desired_age_max))
    except TypeError:
    ...
    try:
        ...
        print('Using lower age threshold of {0:g}...'.format(desired_age_min))
    except TypeError:
        desired_age_min = -1.0
